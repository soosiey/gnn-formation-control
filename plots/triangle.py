...
network1 = np.load('positionLists/'+'positionList_network_5.npy')[4]
network2 = np.load('positionLists/'+'positionList_network_7.npy')[3]
network3 = np.load('positionLists/'+'positionList_network_4.npy')[4]
